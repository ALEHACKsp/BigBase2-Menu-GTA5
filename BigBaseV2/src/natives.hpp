...
namespace PLAYER
{
	...
	static void CHANGE_PLAYER_PED(Player player, Ped ped, BOOL p, BOOL resetDamage) { invoke<Void>(0x048189FAC643DEEE, player, ped, p, resetDamage); } // 0x048189FAC643DEEE 0xBE515485
	...
	static BOOL IS_PLAYER_PRESSING_HORN(Vehicle player) { return invoke<BOOL>(0xFA1E2BF8B10598F9, player); } // 0xFA1E2BF8B10598F9 0xED1D1662
	...
	static void SET_ALL_RANDOM_PEDS_FLEE_THIS_FRAME(Blip player) { invoke<Void>(0x471D2FF42A94B4F2, player); } // 0x471D2FF42A94B4F2 0xBF974891
	...
	static void SET_IGNORE_LOW_PRIORITY_SHOCKING_EVENTS(Player player, Hash* toggle) { invoke<Void>(0x596976B02B6B5700, player, toggle); } // 0x596976B02B6B5700 0xA3D675ED
	...
	static void AI_PHONE_ARGS(Player player) { invoke<Void>(0xBC9490CA15AEA8FB, player); } // 0xBC9490CA15AEA8FB 0x6B34A160
	...
	static int GET_PLAYER_MAX_ARMOUR(Any vector) { return invoke<int>(0x92659B4CE1863CB3, vector); } // 0x92659B4CE1863CB3 0x02A50657
	...
	static Object GET_PLAYER_INDEX() { return invoke<Object>(0xA5EDC40EF369B48D); } // 0xA5EDC40EF369B48D 0x309BBDC1
	...
	static Player IS_PLAYER_FREE_FOR_AMBIENT_TASK(Player player) { return invoke<Player>(0xDCCFD3F106C36AB4, player); } // 0xDCCFD3F106C36AB4 0x85C7E232
	...
	static Player NETWORK_PLAYER_ID_TO_INT() { return invoke<Player>(0xEE68096F9F37341E); } // 0xEE68096F9F37341E 0x8DD5B838
	...
	static void FORCE_CLEANUP(Object* cleanupFlags) { invoke<Void>(0xBC8983F38F78ED51, cleanupFlags); } // 0xBC8983F38F78ED51 0xFDAAEA2B
	...
	static Pickup GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP() { return invoke<Pickup>(0x9A41CF4674A12272); } // 0x9A41CF4674A12272 0x39AA9FC8
	...
	static char* GIVE_ACHIEVEMENT_TO_PLAYER(Hash achievement) { return invoke<char*>(0xBEC7076D64130195, achievement); } // 0xBEC7076D64130195 0x822BC992
	...
	static Any* _GET_ACHIEVEMENT_PROGRESSION(Vehicle achId) { return invoke<Any*>(0x1C186837D0619335, achId); } // 0x1C186837D0619335
	static Any* HAS_ACHIEVEMENT_BEEN_PASSED(Vehicle* achievement) { return invoke<Any*>(0x867365E111A3B6EB, achievement); } // 0x867365E111A3B6EB 0x136A5BE9
	...
	static void DISPLAY_SYSTEM_SIGNIN_UI(Blip* unk) { invoke<Void>(0x94DD7888C10A979E, unk); } // 0x94DD7888C10A979E 0x4264CED2
	...
	static void SET_PLAYER_TARGETING_MODE(Blip targetMode) { invoke<Void>(0xB1906895227793F3, targetMode); } // 0xB1906895227793F3 0x61CAE253
	static void _0x5702B917B99DB1CD(BOOL* p0) { invoke<Void>(0x5702B917B99DB1CD, p0); } // 0x5702B917B99DB1CD
	static BOOL _0xB9CF1F793A9F1BF1() { return invoke<BOOL>(0xB9CF1F793A9F1BF1); } // 0xB9CF1F793A9F1BF1
	static void CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(Vehicle* player) { invoke<Void>(0xF0B67A4DE6AB5F98, player); } // 0xF0B67A4DE6AB5F98 0x1D31CBBD
	...
	static void SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(Ped* player, Vehicle multiplier) { invoke<Void>(0xCA7DC8329F0A1E9E, player, multiplier); } // 0xCA7DC8329F0A1E9E 0xF20F72E5
	...
	static Pickup GET_TIME_SINCE_LAST_DEATH() { return invoke<Pickup>(0xC7034807558DDFCA); } // 0xC7034807558DDFCA 0x24BC5AC0
	...
	static void _DISABLE_PLAYER_SOMETHING() { invoke<Void>(0xB885852C39CC265D); } // 0xB885852C39CC265D
	...
	static void _SPECIAL_ABILITY_CHARGE_ON_MISSION_FAILED(Player player) { invoke<Void>(0xC9A763D8FE87436A, player); } // 0xC9A763D8FE87436A 0x4136829A
	...
	static void SPECIAL_ABILITY_CHARGE_LARGE(Player player, int p1, Hash p2) { invoke<Void>(0xF733F45FA4497D93, player, p1, p2); } // 0xF733F45FA4497D93 0xF440C04D
	...
	static BOOL IS_SPECIAL_ABILITY_ACTIVE(Ped player) { return invoke<BOOL>(0x3E5F7FC85D854E15, player); } // 0x3E5F7FC85D854E15 0x1B17E334
	...
	static BOOL _IS_PLAYER_WITHIN_TEST_CAPSULE(Player player, float p1) { return invoke<BOOL>(0xDD2620B7B9D16FF1, player, p1); } // 0xDD2620B7B9D16FF1 0x8CB53C9F
	static void START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, BOOL keepVehicle, BOOL keepVelocity, BOOL fadeInOut) { invoke<Void>(0xAD15F075A4DA0FDE, player, x, y, z, heading, keepVehicle, keepVelocity, fadeInOut); } // 0xAD15F075A4DA0FDE 0xC552E06C
	...
	static void SET_PLAYER_PARACHUTE_TINT_INDEX(Ped ped, Vehicle* vehicleindex) { invoke<Void>(0xA3D0E54541D9A5E5, ped, vehicleindex); } // 0xA3D0E54541D9A5E5 0x8EA12EDB
	...
	static Any* GET_PLAYER_HAS_RESERVE_PARACHUTE(Any player) { return invoke<Any*>(0x5DDFE2FF727F3CA3, player); } // 0x5DDFE2FF727F3CA3 0x30DA1DA1
	...
	static void RESET_PLAYER_INPUT_GAIT(Pickup player) { invoke<Void>(0x19531C47A2ABD691, player); } // 0x19531C47A2ABD691 0x4A701EE1
	...
	static Any* _0x690A61A6D13583F6(Player p0) { return invoke<Any*>(0x690A61A6D13583F6, p0); } // 0x690A61A6D13583F6 0x1D371529
	...
	static Any* HAS_PLAYER_BEEN_SPOTTED_IN_STOLEN_VEHICLE(Ped* player) { return invoke<Any*>(0xD705740BB0A1CF4C, player); } // 0xD705740BB0A1CF4C 0x4A01B76A
	static Any* _0x38D28DA81E4E9BF9(ScrHandle player) { return invoke<Any*>(0x38D28DA81E4E9BF9, player); } // 0x38D28DA81E4E9BF9 0x013B4F72
	...
	static Any* IS_PLAYER_RIDING_TRAIN(Vehicle* player) { return invoke<Any*>(0x4EC12697209F2196, player); } // 0x4EC12697209F2196 0x9765E71D
	static Any* HAS_PLAYER_LEFT_THE_WORLD(Ped* player) { return invoke<Any*>(0xD55DDFB47991A294, player); } // 0xD55DDFB47991A294 0xFEA40B6C
	...
	static Any* _0x65FAEE425DE637B0(BOOL player) { return invoke<Any*>(0x65FAEE425DE637B0, player); } // 0x65FAEE425DE637B0
	static void _SET_UNK_FRAMEFLAG(Vehicle* player) { invoke<Void>(0x5501B7A5CDB79D37, player); } // 0x5501B7A5CDB79D37
	static Any _0x56105E599CAB0EFA(Ped p7) { return invoke<Any>(0x56105E599CAB0EFA, p7); } // 0x56105E599CAB0EFA
}
...
namespace ENTITY
{
	...
	static BOOL IS_ENTITY_AN_OBJECT(Player* entity) { return invoke<BOOL>(0x8D68C8FD0FACA94E, entity); } // 0x8D68C8FD0FACA94E 0x3F52E561
	...
	static void _SET_ENTITY_NOT_HAVE_ADVANCED_PHYSICS(Entity entity, BOOL toggle) { invoke<Void>(0x3910051CCECDB00C, entity, toggle); } // 0x3910051CCECDB00C 0xD3850671
	...
	static void _SET_ENTITY_COMPLETELY_DISABLE_COLLISION(Entity entity, BOOL p1, BOOL p2) { invoke<Void>(0x9EBC85ED0FFFE51C, entity, p1, p2); } // 0x9EBC85ED0FFFE51C
	...
	static void SET_ENTITY_PROOFS(Entity entity, BOOL bulletProof, BOOL fireProof, BOOL explosionProof, BOOL collisionProof, BOOL meleeProof, BOOL steamProof, BOOL smokeProof, BOOL drownProof) { invoke<Void>(0xFAEE099C6F890BB8, entity, bulletProof, fireProof, explosionProof, collisionProof, meleeProof, steamProof, smokeProof, drownProof); } // 0xFAEE099C6F890BB8 0x7E9EAB66
...
namespace PED
{
	...
	static Ped CREATE_PED_INSIDE_VEHICLE(Ped vehicle, int pedType, Hash modelHash, int seat, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Ped>(0x7DD959874C1FD534, vehicle, pedType, modelHash, seat, isNetwork, thisScriptCheck); } // 0x7DD959874C1FD534 0x3000F092
	...
	static void _FAIL_MISSION(BOOL toggle) { invoke<Void>(0xF2BEBCDFAFDAA19E, toggle); } // 0xF2BEBCDFAFDAA19E 0x6CD58238
	...
	static void _SET_PED_SHOOTING_RATE(Ped ped, float unk) { invoke<Void>(0xEC4B4B3B9908052A, ped, unk); } // 0xEC4B4B3B9908052A 0xF30658D2
	...
	static void SET_PED_AS_COP(Ped Player, BOOL True) { invoke<Void>(0xBB03C38DD3FB7FFD, Player, True); } // 0xBB03C38DD3FB7FFD 0x84E7DE9F
	...
	static void SET_PED_MOVEMENT_CLIPSET(BOOL player, BOOL clipSet, float blendTime) { invoke<Void>(0xAF8A94EDE7712BEF, player, clipSet, blendTime); } // 0xAF8A94EDE7712BEF 0xA817CDEB
	...
	static int GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(Ped SC, int sc) { return invoke<int>(0x27561561732A7842, SC, sc); } // 0x27561561732A7842 0x9754C27D
	...
	static int GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(Ped mp_f_freemode_01, int ComponentID, int DrawableID) { return invoke<int>(0x8F7156A3142A6BAD, mp_f_freemode_01, ComponentID, DrawableID); } // 0x8F7156A3142A6BAD 0x83D9FBE7
	...
	static BOOL _ARE_COMPONENTS_LOADED(Ped p0) { return invoke<BOOL>(0x66680A92700F43DF, p0); } // 0x66680A92700F43DF 0xC6517D52
	...
	static BOOL _IS_PED_GETTING_ON_BIKE(Ped ped) { return invoke<BOOL>(0x784002A632822099, ped); } // 0x784002A632822099 0x3B0CA391
	...
	static void SET_PED_PROP_INDEX(Ped ped, int componentId, int drawableId, int TextureId, BOOL isNetworkGame) { invoke<Void>(0x93376B65A266EB5F, ped, componentId, drawableId, TextureId, isNetworkGame); } // 0x93376B65A266EB5F 0x0829F2E2
	...
	static BOOL GET_PED_DECORATIONS_STATE(Ped ped) { return invoke<BOOL>(0x71EAB450D86954A1, ped); } // 0x71EAB450D86954A1 0x47187F7F
	...
	static void _CLEAR_PED_SOMETHING(Ped ped) { invoke<Void>(0x6585D955A68452A5, ped); } // 0x6585D955A68452A5 0xA993915F
	...
	static void SET_PED_COMBAT_ABILITY(Ped ped, int ability) { invoke<Void>(0xC7622C0D36B2FDA8, ped, ability); } // 0xC7622C0D36B2FDA8 0x6C23D329
	...
	static void _SET_PED_FAST_ANIMATIONS(Ped ped, BOOL p1, BOOL p2) { invoke<Void>(0x2208438012482A1A, ped, p1, p2); } // 0x2208438012482A1A 0x187B9070
	...
	static BOOL _0xF60165E1D2C5370B(Ped ped, Any* p1, float* p2) { return invoke<BOOL>(0xF60165E1D2C5370B, ped, p1, p2); } // 0xF60165E1D2C5370B
	...
	static void SET_PED_USING_ACTION_MODE(Ped ped, BOOL state, int timeout, char* action) { invoke<Void>(0xD75ACCF5E0FB5367, ped, state, timeout, action); } // 0xD75ACCF5E0FB5367 0x8802F696
	...
	static BOOL _0xF0DAEF2F545BEE25(int headshotHandle) { return invoke<BOOL>(0xF0DAEF2F545BEE25, headshotHandle); } // 0xF0DAEF2F545BEE25 0x10F2C023
	...
	static void _SET_PED_HEATSCALE_OVERRIDE(Any p0, Any p1) { invoke<Void>(0xC1F6EBF9A3D55538, p0, p1); } // 0xC1F6EBF9A3D55538 0xEF9142DB
...
namespace VEHICLE
{
	...
	static int _GET_VEHICLE_WEAPON_TARGET_LOCK_STATUS(Vehicle vehicle) { return invoke<int>(0xE6B0E8CFC3633BF0, vehicle); } // 0xE6B0E8CFC3633BF0 0xFBDE9FD8
	...
	static void SET_DISABLE_RANDOM_TRAINS_THIS_FRAME(BOOL toggle) { invoke<Void>(0xD4B8E3D1917BC86B, toggle); } // 0xD4B8E3D1917BC86B 0x09462665
	...
	static void SET_VEHICLE_DOORS_LOCKED(int* vehicle, float* doorLockStatus) { invoke<Void>(0xB664292EAECF7FA6, vehicle, doorLockStatus); } // 0xB664292EAECF7FA6 0x4CDD35D0
	...
	static void SET_VEHICLE_DOORS_LOCKED_FOR_NON_SCRIPT_PLAYERS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x9737A37136F07E75, vehicle, toggle); } // 0x9737A37136F07E75 0xE4EF6514
	...
	static void BRING_VEHICLE_TO_HALT(Vehicle vehicle, float distance, int type, BOOL unknown) { invoke<Void>(0x260BE8F09E326A20, vehicle, distance, type, unknown); } // 0x260BE8F09E326A20 0xCBC7D3C8
	...
	static void GET_RANDOM_VEHICLE_MODEL_IN_MEMORY(BOOL p0, int modelHash, int* p2) { invoke<Void>(0x055BF0AC0C34F4FD, p0, modelHash, p2); } // 0x055BF0AC0C34F4FD 0xE2C45631
	...
	static Hash _GET_VEHICLE_SEAT_CLIPSET_HASH(Vehicle vehicle, int seat) { return invoke<Hash>(0xA01BC64DD4BFBBAC, vehicle, seat); } // 0xA01BC64DD4BFBBAC
	...
	static void REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(Ped x1, Ped y1, Ped z1, Ped x2, Ped y2, Ped z2, Vehicle unk) { invoke<Void>(0x46A1E1A299EC4BBA, x1, y1, z1, x2, y2, z2, unk); } // 0x46A1E1A299EC4BBA 0x42CC15E0
	...
	static float GET_HELI_TAIL_BOOM_HEALTH(Vehicle vehicle) { return invoke<float>(0xAC51915D27E4A5F7, vehicle); } // 0xAC51915D27E4A5F7 0x8A68388F
	...
	static void ATTACH_VEHICLE_TO_TOW_TRUCK(Vehicle towTruck, Vehicle vehicle, int index, float hookOffsetX, float hookOffsetY, float hookOffsetZ) { invoke<Void>(0x29A16F8D621C4508, towTruck, vehicle, index, hookOffsetX, hookOffsetY, hookOffsetZ); } // 0x29A16F8D621C4508 0x8151571A
	...
	static void SET_VEHICLE_BULLDOZER_ARM_POSITION(Vehicle vehicle, float position, BOOL p2) { invoke<Void>(0xF8EBCCC96ADB9FB7, vehicle, position, p2); } // 0xF8EBCCC96ADB9FB7 0xED23C8A3
	...
	static void MODIFY_VEHICLE_TOP_SPEED(Vehicle vehicle, float value) { invoke<Void>(0x93A3996368C94158, vehicle, value); } // 0x93A3996368C94158 0xE943B09C
	...
	static void _GET_BOAT_BOOM_POSITION_RATIO(Any p0, BOOL p1) { invoke<Void>(0xC1F981A6F74F0C23, p0, p1); } // 0xC1F981A6F74F0C23 0x00966934
	...
	static void _REMOVE_VEHICLE_OWNERSHIP(Vehicle vehicle) { invoke<Void>(0xCFD778E7904C255E, vehicle); } // 0xCFD778E7904C255E 0x3FBE904F
	...
	static void _ADD_VEHICLE_SHADOW(Vehicle vehicle, int p1, int p2) { invoke<Void>(0xF0E4BA16D1DB546C, vehicle, p1, p2); } // 0xF0E4BA16D1DB546C 0x5BD8D82D
	...
	static void _DEBUG_VEHICLE(Vehicle vehicle) { invoke<Void>(0xB264C4D2F2B0A78B, vehicle); } // 0xB264C4D2F2B0A78B 0x45F72495
	...
	static void _CLEAR_VEHICLE_ROUTE_HISTORY(Vehicle vehicle) { invoke<Void>(0x6D6AF961B72728AE, vehicle); } // 0x6D6AF961B72728AE 0x8DD9AA0C
	...
	static void _GET_VEHICLE_SUSPENSION_DIMENSIONS(Vehicle vehicle, Vector3* out1, Vector3* out2) { invoke<Void>(0xDF7E3EEB29642C38, vehicle, out1, out2); } // 0xDF7E3EEB29642C38
...
namespace OBJECT
{
	static Object CREATE_OBJECT(Hash modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { return invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); } // 0x509D5878EB39E842 0x2F7AA05C
...
namespace AI
{
	...
	static void _SET_PED_PATH_SPEED(Ped ped, float p1) { invoke<Void>(0x88E32DB8C1A4AA4B, ped, p1); } // 0x88E32DB8C1A4AA4B 0x55E06443
	...
	static void STOP_ANIM_TASK(Ped ped, char* animDictionary, char* animationName, float blendoutSpeed) { invoke<Void>(0x97FF36A1D40EA00A, ped, animDictionary, animationName, blendoutSpeed); } // 0x97FF36A1D40EA00A 0x2B520A57
	...
	static BOOL DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(float x, float y, float z, char* scenarioName, float radius, BOOL p5) { return invoke<BOOL>(0x0A9D0C2A3BBC86C1, x, y, z, scenarioName, radius, p5); } // 0x0A9D0C2A3BBC86C1 0x0FB138A5
	...
	static void TASK_COMBAT_HATED_TARGETS_AROUND_PED_TIMED(Ped ped, float radius, int duration, BOOL unk) { invoke<Void>(0x2BBA30B854534A0C, ped, radius, duration, unk); } // 0x2BBA30B854534A0C 0xF127AD6A
	...
	static BOOL _IS_TASK_MOVE_SCRIPTED_ACTIVE(Ped handle) { return invoke<BOOL>(0x921CE12C489C4C41, handle); } // 0x921CE12C489C4C41 0x902656EB
	static BOOL _0x30ED88D5E0C56A37(Any p0) { return invoke<BOOL>(0x30ED88D5E0C56A37, p0); } // 0x30ED88D5E0C56A37 0x92FDBAE6
	static Any _SET_NETWORK_TASK_ACTION(Ped ped, char* p1) { return invoke<Any>(0xD01015C7316AE176, ped, p1); } // 0xD01015C7316AE176 0x885724DE
	static Any _0xAB13A5565480B6D9(Ped ped, char* unk) { return invoke<Any>(0xAB13A5565480B6D9, ped, unk); } // 0xAB13A5565480B6D9
	static char* _GET_PED_NETWORK_TASK_PHASE(Ped ped) { return invoke<char*>(0x717E4D1F2048376D, ped); } // 0x717E4D1F2048376D 0x96C0277B
	static void _SET_NETWORK_TASK_PARAM_FLOAT(Ped ped, char* p1, float p2) { invoke<Void>(0xD5BB4025AE449A4E, ped, p1, p2); } // 0xD5BB4025AE449A4E 0xA79BE783
	static void _SET_NETWORK_TASK_PARAM_BOOL(Ped ped, char* p1, BOOL p2) { invoke<Void>(0xB0A6CFD2C69C1088, ped, p1, p2); } // 0xB0A6CFD2C69C1088 0xF3538041
...
namespace GAMEPLAY
{
	...
	static void SET_MISSION_FLAG(BOOL setToTrueOrNot) { invoke<Void>(0xC4301E5121A0ED73, setToTrueOrNot); } // 0xC4301E5121A0ED73 0x57592D52
	static BOOL GET_MISSION_FLAG() { return invoke<BOOL>(0xA33CDCCDA663159E); } // 0xA33CDCCDA663159E 0x95115F97
	static void SET_RANDOM_EVENT_FLAG(BOOL setToTrueOrNot) { invoke<Void>(0x971927086CFD2158, setToTrueOrNot); } // 0x971927086CFD2158 0xA77F31E8
	...
	static void _GET_WEATHER_TYPE_TRANSITION(Any p1, Any p2, Any p3) { invoke<Void>(0xF3BBE884A14BB413, p1, p2, p3); } // 0xF3BBE884A14BB413 0x9A5C1D56
	static void _SET_WEATHER_TYPE_TRANSITION(Any p1, Any p2, Any p3) { invoke<Void>(0x578C752848ECFA0C, p1, p2, p3); } // 0x578C752848ECFA0C 0x5CA74040
	...
	static void _SET_NEARBY_WAVE_HEIGHT(float p0) { invoke<Void>(0xC54A08C85AE4D410, p0); } // 0xC54A08C85AE4D410 0xDA02F415
	...
	static BOOL GET_GROUND_Z_FOR_3D_COORD(float x, float y, float z, float* groundZ, BOOL ignoreWater) { return invoke<BOOL>(0xC906A7DAB05C8D2B, x, y, z, groundZ, ignoreWater); } // 0xC906A7DAB05C8D2B 0xA1BFD5E0
	static BOOL GET_GROUND_Z_AND_NORMAL_FOR_3D_COORD(float x, float y, float z, float* groundZ, Vector3* offsets) { return invoke<BOOL>(0x8BDC7BFC57A81E76, x, y, z, groundZ, offsets); } // 0x8BDC7BFC57A81E76 0x64D91CED
	...
	static void SET_SAVE_MENU_ACTIVE(BOOL openSaveMenu) { invoke<Void>(0xC9BF75D28165FF77, openSaveMenu); } // 0xC9BF75D28165FF77 0xF5CCF164
	...
	static int ADD_HOSPITAL_RESTART(float x, float y, float z, float heading, int hospitalId) { return invoke<int>(0x1F464EF988465A81, x, y, z, heading, hospitalId); } // 0x1F464EF988465A81 0x4F3E3104
	...
	static void _ENABLE_ALL_STUNTJUMP_SETS(BOOL p0) { invoke<Void>(0xD79185689F8FD5DF, p0); } // 0xD79185689F8FD5DF 0x3C806A2D
	...
	static void BLOCK_DISPATCH_SERVICE_RESOURCE_CREATION(int dispatchType, BOOL toggle) { invoke<Void>(0x9B2BD3773123EA2F, dispatchType, toggle); } // 0x9B2BD3773123EA2F 0xE0F0684F
	...
	static void _SAVE_NEXT_KEYBOARD_INPUT(int p0) { invoke<Void>(0x3ED1438C1F5C6612, p0); } // 0x3ED1438C1F5C6612 0x3301EA47
	...
	static void _START_BENCHMARK_TEST() { invoke<Void>(0x92790862E36C2ADA); } // 0x92790862E36C2ADA
...
namespace AUDIO
{
	...
	static void PAUSE_SCRIPTED_CONVERSATION(BOOL finishCurLine) { invoke<Void>(0x8530AD776CD72B12, finishCurLine); } // 0x8530AD776CD72B12 0xE2C9C6F8
	...
	static void INTERRUPT_CONVERSATION(Ped targ, char* gxtLine, char* charName) { invoke<Void>(0xA018A12E5C5C2FA6, targ, gxtLine, charName); } // 0xA018A12E5C5C2FA6 0xF3A67AF3
	static void _INTERRUPT_CONVERSATION_AND_PAUSE(Ped p0, char* p1, char* p2) { invoke<Void>(0x8A694D7A68F8DC38, p0, p1, p2); } // 0x8A694D7A68F8DC38
	...
	static void _PLAY_ANIMAL_VOCALIZATION(Entity entity, int unk, char* speech) { invoke<Void>(0xEE066C7006C49C0A, entity, unk, speech); } // 0xEE066C7006C49C0A 0x498849F3
	static BOOL _IS_ANIMAL_VOCALIZATION_PLAYING(Any p0) { return invoke<BOOL>(0xC265DF9FB44A9FBD, p0); } // 0xC265DF9FB44A9FBD 0x0CBAF2EF
	...
	static void _TUNE_FORWARD() { invoke<Void>(0xFF266D1D0EB1195D); } // 0xFF266D1D0EB1195D 0x53DB6994
	static void _TUNE_BACKWARD() { invoke<Void>(0xDD6BCF9E94425DF9); } // 0xDD6BCF9E94425DF9 0xD70ECC80
	...
	static void SET_RADIO_TRACK(char* radioStation, char* effectOrEvent) { invoke<Void>(0xB39786F201FEE30B, radioStation, effectOrEvent); } // 0xB39786F201FEE30B 0x76E96212
	...
	static BOOL _DOES_PLAYER_VEH_HAVE_RADIO() { return invoke<BOOL>(0x109697E2FFBAC8A1); } // 0x109697E2FFBAC8A1 0x46B0C696
	...
	static void _SET_CUSTOM_RADIO_TRACK_LIST(char* radioStation, char* trackList, BOOL b) { invoke<Void>(0x4E404A9361F75BB2, radioStation, trackList, b); } // 0x4E404A9361F75BB2 0x128C3873
	static void _CLEAR_CUSTOM_RADIO_TRACK_LIST(char* radioStation) { invoke<Void>(0x1654F24A88A8E3FE, radioStation); } // 0x1654F24A88A8E3FE 0x1D766976
	...
	static void _SET_RADIO_STATION_MUSIC_ONLY(char* radioStation, BOOL p1) { invoke<Void>(0x774BD811F656A122, radioStation, p1); } // 0x774BD811F656A122 0xB1FF7137
	...
	static void _ENABLE_STALL_WARNING_SOUNDS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xC15907D667F7CFB2, vehicle, toggle); } // 0xC15907D667F7CFB2 0x563B635D
	...
	static void _0x18EB48CFC41F2EA0(Ped p, float p1) { invoke<Void>(0x18EB48CFC41F2EA0, p, p1); } // 0x18EB48CFC41F2EA0 0x308ED0EC
...
namespace CUTSCENE
{
	static void REQUEST_CUTSCENE(char* cutsceneName, int id) { invoke<Void>(0x7A86743F475D9E09, cutsceneName, id); } // 0x7A86743F475D9E09 0xB5977853
	...
	static void START_CUTSCENE(int id) { invoke<Void>(0x186D5CB5E7B0FF7B, id); } // 0x186D5CB5E7B0FF7B 0x210106F6
	...
	static BOOL HAS_CUTSCENE_CUT_THIS_FRAME() { return invoke<BOOL>(0x708BDD8CD795B043); } // 0x708BDD8CD795B043 0x4315A7C5
}
...
namespace CAM
{
	...
	static void SET_FLY_CAM_HORIZONTAL_RESPONSE(Any p0, float p1, float p2, float p3) { invoke<Void>(0x503F5920162365B2, p0, p1, p2, p3); } // 0x503F5920162365B2 0x56F9ED27
	static void SET_FLY_CAM_MAX_HEIGHT(Cam cam, float range) { invoke<Void>(0xF9D02130ECDD1D77, cam, range); } // 0xF9D02130ECDD1D77 0x71570DBA
	static void SET_FLY_CAM_COORD_AND_CONSTRAIN(Any p0, float p1, float p2, float p3) { invoke<Void>(0xC91C6C55199308CA, p0, p1, p2, p3); } // 0xC91C6C55199308CA 0x60B345DE
	...
	static int _GET_CAM_VIEW_MODE(int viewType) { return invoke<int>(0xEE778F8C7E1142E2, viewType); } // 0xEE778F8C7E1142E2 0xF3B148A6
	static void _SET_CAM_PERSPECTIVE(Cam p0, Any perspective) { invoke<Void>(0x2A2173E46DAECD12, p0, perspective); } // 0x2A2173E46DAECD12 0x1DEBCB45
	static int _GET_CAM_VIEW_TYPE() { return invoke<int>(0x19CAFA3C87F7C2FF); } // 0x19CAFA3C87F7C2FF
	...
	static float _GET_GAMEPLAY_CAM_FOV() { return invoke<float>(0x80EC114669DAEFF4); } // 0x80EC114669DAEFF4 0x721B763B
	...
	static void _F4F2C0D4EE209E20() { invoke<Void>(0xF4F2C0D4EE209E20); } // 0xF4F2C0D4EE209E20 0xD75CDD75
...
namespace WEAPON
{
	...
	static float GET_LOCKON_DISTANCE_OF_CURRENT_PED_WEAPON(Ped ped) { return invoke<float>(0x840F03E9041E2C9C, ped); } // 0x840F03E9041E2C9C 0x3612110D
	...
	static void REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(Object weaponObject, Hash component) { invoke<Void>(0xF7D82B0D66777611, weaponObject, component); } // 0xF7D82B0D66777611 0xA6E7ED3C
	...
	static float _0x3133B907D8B32053(Hash weapon, int p1) { return invoke<float>(0x3133B907D8B32053, weapon, p1); } // 0x3133B907D8B32053
	...
	static Entity SET_PED_SHOOT_ORDNANCE_WEAPON(Ped ped, BOOL p1) { return invoke<Entity>(0xB4C8D77C80C0421E, ped, p1); } // 0xB4C8D77C80C0421E 0xEC2E5304
...
namespace STREAMING
{
	...
	static void SET_FOCUS_POS_AND_VEL(float x, float y, float z, float offsetX, float offsetY, float offsetZ) { invoke<Void>(0xBB7454BAFF08FE25, x, y, z, offsetX, offsetY, offsetZ); } // 0xBB7454BAFF08FE25 0x14680A60
	...
	static void _SET_MAPDATACULLBOX_ENABLED(char* p0, BOOL p1) { invoke<Void>(0xAF12610C644A35C9, p0, p1); } // 0xAF12610C644A35C9 0x403CD434
...
namespace SCRIPT
{
	static void REQUEST_SCRIPT(Player* Playermenu) { invoke<Void>(0x6EB5F71AA68F2E8E, Playermenu); } // 0x6EB5F71AA68F2E8E 0xE26B2666
	...
	static void TRIGGER_SCRIPT_EVENT(int eventGroup, Any* args, int argCount, int bit) { invoke<Void>(0x5AE99C571D5BBE5D, eventGroup, args, argCount, bit); } // 0x5AE99C571D5BBE5D 0x54763B35
...
namespace UI
{
	static void BEGIN_TEXT_COMMAND_BUSYSPINNER_ON(char* string) { invoke<Void>(0xABA17D7CE615ADBF, string); } // 0xABA17D7CE615ADBF 0xCB7C8994
	...
	static void _REMOVE_BUSY_SPINNER() { invoke<Void>(0xC65AB383CD91DF98); } // 0xC65AB383CD91DF98 0x71077FBD
	...
	static BOOL _0x3D9ACB1EB139E702() { return invoke<BOOL>(0x3D9ACB1EB139E702); } // 0x3D9ACB1EB139E702
	...
	static void THEFEED_PAUSE() { invoke<Void>(0xFDB423997FA30340); } // 0xFDB423997FA30340 0x4D0449C6
	static void THEFEED_RESUME() { invoke<Void>(0xE1CD1E48E025E661); } // 0xE1CD1E48E025E661 0xD3F40140
	static BOOL THEFEED_IS_PAUSED() { return invoke<BOOL>(0xA9CBFD40B3FA3010); } // 0xA9CBFD40B3FA3010 0xC5223796
	...
	static void _RESET_NOTIFICATION_DATA() { invoke<Void>(0xADED7F5748ACAFE6); } // 0xADED7F5748ACAFE6 0x1D6859CA
	...
	static void BEGIN_TEXT_COMMAND_THEFEED_POST(char* text) { invoke<Void>(0x202709F4C58A0424, text); } // 0x202709F4C58A0424 0x574EE85C
	static int _SET_NOTIFICATION_MESSAGE(char* picName1, char* picName2, BOOL flash, int iconType, BOOL _nonExistent, char* sender, char* subject) { return invoke<int>(0x2B7E9A4EAAA93C89, picName1, picName2, flash, iconType, _nonExistent, sender, subject); } // 0x2B7E9A4EAAA93C89 0xED130FA1
	...
	static void BEGIN_TEXT_COMMAND_OVERRIDE_BUTTON_TEXT(char* p0) { invoke<Void>(0x8F9EE5687F8EECCD, p0); } // 0x8F9EE5687F8EECCD 0xBF855650
	static void END_TEXT_COMMAND_OVERRIDE_BUTTON_TEXT(BOOL p0) { invoke<Void>(0xA86911979638106F, p0); } // 0xA86911979638106F 0x6E7FDA1C
	...
	static void ADD_TEXT_COMPONENT_SUBSTRING_PHONE_NUMBER(char* p0, int p1) { invoke<Void>(0x761B77454205A61D, p0, p1); } // 0x761B77454205A61D 0x65E1D404
	...
	static void ADD_TEXT_COMPONENT_SUBSTRING_KEYBOARD_DISPLAY(char* p0) { invoke<Void>(0x5F68520888E69014, p0); } // 0x5F68520888E69014 0x0829A799
	...
	static void _DISPLAY_HUD_WHEN_PAUSED_THIS_FRAME() { invoke<Void>(0x402F9ED62087E898); } // 0x402F9ED62087E898 0xC47AB1B0
	...
	static void REPLACE_HUD_COLOUR(int hudColorIndex, int hudColorIndex2) { invoke<Void>(0x1CCC708F0F850613, hudColorIndex, hudColorIndex2); } // 0x1CCC708F0F850613 0x3B216749
	...
	static void TRIGGER_SONAR_BLIP(float posX, float posY, float posZ, float radius, int p4) { invoke<Void>(0x72DD432F3CDFC0EE, posX, posY, posZ, radius, p4); } // 0x72DD432F3CDFC0EE 0xBF25E7B2
	...
	static void _HIDE_CURRENT_INTERIOR_ON_MAP() { invoke<Void>(0x20FE7FDFEEAD38C0); } // 0x20FE7FDFEEAD38C0 0xCE36E3FE
	...
	static void _HIDE_WEAPON_HASH(Hash weaponHash) { invoke<Void>(0x72C1056D678BB7D8, weaponHash); } // 0x72C1056D678BB7D8 0x83B608A0
	...
	static void _0x311438A071DD9B1A(float x, float y, float z) { invoke<Void>(0x311438A071DD9B1A, x, y, z); } // 0x311438A071DD9B1A 0xEEBDFE55
	...
	static BOOL GET_HUD_SCREEN_POSITION_FROM_WORLD_POSITION(float worldX, float worldY, float worldZ, float* screenX, float* screenY) { return invoke<BOOL>(0xF9904D11F1ACBEC3, worldX, worldY, worldZ, screenX, screenY); } // 0xF9904D11F1ACBEC3 0xFE9A39F8
	...
	static BOOL IS_FLOATING_HELP_TEXT_ON_SCREEN(Any p0) { return invoke<BOOL>(0x2432784ACA090DA4, p0); } // 0x2432784ACA090DA4 0x45472FD5
	static void SET_FLOATING_HELP_TEXT_SCREEN_POSITION(Any p0, float p1, float p2) { invoke<Void>(0x7679CC1BCEBE3D4C, p0, p1, p2); } // 0x7679CC1BCEBE3D4C 0x198F32D7
	static void SET_FLOATING_HELP_TEXT_WORLD_POSITION(Any p0, float x, float y, float z) { invoke<Void>(0x784BA7E0ECEB4178, p0, x, y, z); } // 0x784BA7E0ECEB4178 0x93045157
	static void SET_FLOATING_HELP_TEXT_TO_ENTITY(Any p0, Any p1, float p2, float p3) { invoke<Void>(0xB094BC1DB4018240, p0, p1, p2, p3); } // 0xB094BC1DB4018240 0x18B012B7
	static void SET_FLOATING_HELP_TEXT_STYLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x788E7FD431BD67F1, p0, p1, p2, p3, p4, p5); } // 0x788E7FD431BD67F1 0x97852A82
	...
	static BOOL IS_MP_GAMER_TAG_MOVIE_ACTIVE() { return invoke<BOOL>(0x6E0EB3EB47C8D7AA); } // 0x6E0EB3EB47C8D7AA 0xEFD2564A
	static int CREATE_FAKE_MP_GAMER_TAG(Ped ped, char* username, BOOL pointedClanTag, BOOL isRockstarClan, char* clanTag, Any p5) { return invoke<int>(0xBFEFE3321A3F5015, ped, username, pointedClanTag, isRockstarClan, clanTag, p5); } // 0xBFEFE3321A3F5015 0xF5CD2AA4
	...
	static BOOL _GET_CURRENT_WEBSITE_PAGE_ID(int websiteID) { return invoke<BOOL>(0xE3B05614DCE1D014, websiteID); } // 0xE3B05614DCE1D014 0xD217EE7E
	...
	static BOOL _CREATE_DRAW_LIST(Any p0, char* text, Any p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0x0C5A80A9E096D529, p0, text, p2, p3, p4, p5); } // 0x0C5A80A9E096D529
...
namespace GRAPHICS
{
	...
	static int _GET_LIVEAREA_SOMETHING(Any p0) { return invoke<int>(0x40AFB081F8ADD4EE, p0); } // 0x40AFB081F8ADD4EE 0x762E5C5F
	...
	static void _SET_UNK_TIMECYCLE_MODIFIER(int unk) { invoke<Void>(0xE3E2C1B4C59DBC77, unk); } // 0xE3E2C1B4C59DBC77 0xD8CC7221
	...
	static BOOL _START_NETWORKED_PARTICLE_FX_NON_LOOPED_ON_ENTITY(char* effectName, Entity entity, float offsetX, float offsetY, float offsetZ, float rotX, float rotY, float rotZ, float scale, BOOL axisX, BOOL axisY, BOOL axisZ) { return invoke<BOOL>(0xC95EB1DB6E92113D, effectName, entity, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, scale, axisX, axisY, axisZ); } // 0xC95EB1DB6E92113D
	...
	static void WASH_DECALS_IN_RANGE(float x, float y, float z, float radius, float intensity) { invoke<Void>(0x9C30613D50A6ADEF, x, y, z, radius, intensity); } // 0x9C30613D50A6ADEF 0xDEECBC57
	...
	static void _START_PETROL_TRAIL_DECALS(float p0) { invoke<Void>(0x99AC7F0D8B9C893D, p0); } // 0x99AC7F0D8B9C893D 0xE3938B0B
	...
	static void _END_PETROL_TRAIL_DECALS() { invoke<Void>(0x0A123435A26C36CD); } // 0x0A123435A26C36CD 0xCCCA6855
	...
	static void _SET_TIMECYCLE_MODIFIER2(char* p0) { invoke<Void>(0x5096FD9CCB49056D, p0); } // 0x5096FD9CCB49056D 0x908A335E
	...
	static void _DRAW_SCALEFORM_MOVIE_3D_NON_ADDITIVE(int scaleform, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, float p7, float p8, float p9, float scaleX, float scaleY, float scaleZ, Any rotationOrder) { invoke<Void>(0x1CE592FDC749D6F5, scaleform, posX, posY, posZ, rotX, rotY, rotZ, p7, p8, p9, scaleX, scaleY, scaleZ, rotationOrder); } // 0x1CE592FDC749D6F5 0x899933C8
	...
	static BOOL IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(int method_return) { return invoke<BOOL>(0x768FF8961BA904D6, method_return); } // 0x768FF8961BA904D6 0x5CD7C3C0
	...
	static void _REQUEST_SCALEFORM_SCRIPT_HUD_MOVIE(int hudComponent) { invoke<Void>(0x9304881D6F6537EA, hudComponent); } // 0x9304881D6F6537EA 0x7AF85862
	...
	static void _SWITCH_HUD(char* graphicsName) { invoke<Void>(0xD2209BE128B5418C, graphicsName); } // 0xD2209BE128B5418C
}
...
namespace STATS
{
	...
	static BOOL STAT_SET_USER_ID(Hash playerName, char* value, BOOL save) { return invoke<BOOL>(0x8CDDF1E452BABE11, playerName, value, save); } // 0x8CDDF1E452BABE11 0xDBE78ED7
	...
	static char* STAT_GET_USER_ID(Any* playerName) { return invoke<char*>(0x2365C388E393BBE2, playerName); } // 0x2365C388E393BBE2 0xE2E8B6BA
	...
	static void _0x26D7399B9587FE89(int characterIndex) { invoke<Void>(0x26D7399B9587FE89, characterIndex); } // 0x26D7399B9587FE89 0x343B27E2
	...
	static void PLAYSTATS_AWARD_XP(int xp, Hash hash1, Hash hash2) { invoke<Void>(0x46F917F6B4128FE4, xp, hash1, hash2); } // 0x46F917F6B4128FE4 0x8770017B
	...
	static void _SET_PROFILE_SETTING_933(int value) { invoke<Void>(0xF1A1803D3476F215, value); } // 0xF1A1803D3476F215 0xA3DAC790
	static void _SET_PROFILE_SETTING_934(int value) { invoke<Void>(0x38BAAA5DD4C9D19F, value); } // 0x38BAAA5DD4C9D19F 0x726FAE66
	static void _SET_PROFILE_SETTING_935(int value) { invoke<Void>(0x55384438FC55AD8E, value); } // 0x55384438FC55AD8E 0xF03895A4
	...
	static void _UNLOCK_EXCLUS_CONTENT(Any bitset) { invoke<Void>(0xDAC073C7901F9E15, bitset); } // 0xDAC073C7901F9E15
	static void _SET_PROFILE_SETTING_501(Any p0) { invoke<Void>(0xF6792800AC95350D, p0); } // 0xF6792800AC95350D
}
...
namespace BRAIN
{
	...
	static void _STOP_ALL_SCRIPTS() { invoke<Void>(0x0B40ED49D7D6FF84); } // 0x0B40ED49D7D6FF84 0x19B27825
	static void _FLUSH_ALL_SCRIPTS() { invoke<Void>(0x4D953DF78EBF8158); } // 0x4D953DF78EBF8158 0xF3A3AB08
...
namespace MOBILE
{
	...
	static void GET_MOBILE_PHONE_ROTATION(Vector3* rotation, int p1) { invoke<Void>(0x1CEFB61F193070AE, rotation, p1); } // 0x1CEFB61F193070AE 0x17A29F23
	...
	static void CELL_CAM_ACTIVATE(BOOL toggle, BOOL p1) { invoke<Void>(0xFDE8F069C542D126, toggle, p1); } // 0xFDE8F069C542D126 0x234C1AE9
...
namespace PATHFIND
{
	...
	static Any GET_CLOSEST_ROAD(float posX, float posY, float posZ, float p3, int p4, Vector3* p5, Vector3* p6, int* p7, int* p8, float* p9, int p10) { return invoke<Any>(0x132F52BBA570FE92, posX, posY, posZ, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x132F52BBA570FE92 0x567B0E11
	...
	static void _UNLOAD_ALL_PATH_NODES(BOOL keepInMemory) { invoke<Void>(0x228E5C6AD4D74BFD, keepInMemory); } // 0x228E5C6AD4D74BFD 0xD6A3B458
	...
	static void SET_GPS_DISABLED_ZONE(float x1, float y1, float z1, float x2, float y2, float z2) { invoke<Void>(0xDC20483CD3DD5201, x1, y1, z1, x2, y2, z2); } // 0xDC20483CD3DD5201 0x720B8073
...
namespace CONTROLS
{
	...
	static BOOL _IS_LOOK_NOT_INVERTED() { return invoke<BOOL>(0xE1615EC03B3BB4FD); } // 0xE1615EC03B3BB4FD
...
namespace DATAFILE
{
	...
	static BOOL _SEND_UGC_DATAFILE(int p0) { return invoke<BOOL>(0xA69AC4ADE82B57A4, p0); } // 0xA69AC4ADE82B57A4 0xE8D56DA2
...
namespace FIRE
{
	...
	static int _GET_EXPLOSIONS_IN_AREA(int explosionType, float x1, float y1, float z1, float x2, float y2, float z2) { return invoke<int>(0x6070104B699B2EF4, explosionType, x1, y1, z1, x2, y2, z2); } // 0x6070104B699B2EF4
...
namespace ROPE
{
	...
	static void _HIDE_ROPE(Object rope, int value) { invoke<Void>(0xDC57A637A20006ED, rope, value); } // 0xDC57A637A20006ED 0x80DB77A7
	...
	static void _0xBC0CE682D4D05650(Object rope, int unk, float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4) { invoke<Void>(0xBC0CE682D4D05650, rope, unk, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4); } // 0xBC0CE682D4D05650 0x106BA127
	...
	static void SET_DAMPING(Object ropeorobject, int vertex, float value) { invoke<Void>(0xEEA3B200A6FEB65B, ropeorobject, vertex, value); } // 0xEEA3B200A6FEB65B 0xCFB37773
...
namespace WATER
{
	...
	static int TEST_PROBE_AGAINST_ALL_WATER(float x1, float y1, float z1, float x2, float y2, float z2, int type, Vector3* result) { return invoke<int>(0x8974647ED222EA5F, x1, y1, z1, x2, y2, z2, type, result); } // 0x8974647ED222EA5F 0x4A962D55
...
namespace NETWORK
{
	...
	static BOOL _NETWORK_IS_NP_AVAILABLE() { return invoke<BOOL>(0x8D11E61A4ABF49CC); } // 0x8D11E61A4ABF49CC
	...
	static Any _72D918C99BCACC54(Any p0) { return invoke<Any>(0x72D918C99BCACC54, p0); } // 0x72D918C99BCACC54 0x1F88819D
	...
	static BOOL NETWORK_SESSION_GET_KICK_VOTE(Player player) { return invoke<BOOL>(0xD6D09A6F32F49EF1, player); } // 0xD6D09A6F32F49EF1 0x8A559D26
	...
	static BOOL NETWORK_X_AFFECTS_GAMERS(int crewId) { return invoke<BOOL>(0xE532D6811B3A4D2A, crewId); } // 0xE532D6811B3A4D2A 0x7771AB83
	static BOOL NETWORK_FIND_MATCHED_GAMERS(int attribute, float p1, float lowerLimit, float upperLimit) { return invoke<BOOL>(0xF7B2CFDE5C9F700D, attribute, p1, lowerLimit, upperLimit); } // 0xF7B2CFDE5C9F700D 0xA13045D4
	...
	static void _CLEAR_NET_FUNC_DATA() { invoke<Void>(0x86E0660E4F5C956D); } // 0x86E0660E4F5C956D 0x3F7EDBBD
	...
	static BOOL _NETWORK_IS_CHAT_RESTRICTED() { return invoke<BOOL>(0x74698374C45701D2); } // 0x74698374C45701D2 0x70ED476A
	static void _NETWORK_SET_CHAT_RESTRICTION_THIS_FRAME() { invoke<Void>(0x140E6A44870A11CE); } // 0x140E6A44870A11CE 0x50507BED
	...
	static int _0x53AFD64C6758F2F9() { return invoke<int>(0x53AFD64C6758F2F9); } // 0x53AFD64C6758F2F9
	...
	static BOOL NETWORK_DO_TRANSITION_TO_FREEMODE(Any* netHandle, Any netHandleIndex, BOOL p2, int players, BOOL p4) { return invoke<BOOL>(0x3AAD8B2FCA1E289F, netHandle, netHandleIndex, p2, players, p4); } // 0x3AAD8B2FCA1E289F 0xC7CB8ADF
	...
	static void _MARK_SESSION_AS_JOINED() { invoke<Void>(0x25D990F8E0E3F13C); } // 0x25D990F8E0E3F13C
	static void _0x77FADDCBE3499DF7(Any p0) { invoke<Void>(0x77FADDCBE3499DF7, p0); } // 0x77FADDCBE3499DF7 0x8179C48A
	static void _NETWORK_SET_RANDOM_INT_SEED(int seed) { invoke<Void>(0xF1B84178F8674195, seed); } // 0xF1B84178F8674195 0x41702C8A
	...
	static BOOL NETWORK_PLAYER_GET_CHEATER_REASON() { return invoke<BOOL>(0x172F75B6EE2233BA); } // 0x172F75B6EE2233BA 0x1720ABA6
	static BOOL NETWORK_PLAYER_IS_BADSPORT() { return invoke<BOOL>(0x19D8DA0E5A68045A); } // 0x19D8DA0E5A68045A 0xA19708E3
	static BOOL GET_PLAYER_STAT_STARS_VISIBILITY(Player player, int p1, Hash scriptHash) { return invoke<BOOL>(0x46FB3ED415C7641C, player, p1, scriptHash); } // 0x46FB3ED415C7641C 0xF9A51B92
	...
	static void NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(int lobbySize, BOOL p1, int instanceId) { invoke<Void>(0x1CA59E306ECB80A5, lobbySize, p1, instanceId); } // 0x1CA59E306ECB80A5 0x470810ED
	static BOOL _NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT_2(int numPlayers, BOOL p1, int instanceId) { return invoke<BOOL>(0xD1110739EEADB592, numPlayers, p1, instanceId); } // 0xD1110739EEADB592
	...
	static int NETWORK_GET_HOST_OF_SCRIPT(char* scriptName, int instanceId, int positionHash) { return invoke<int>(0x1D6A14F1F9A736FC, scriptName, instanceId, positionHash); } // 0x1D6A14F1F9A736FC 0x9C95D0BB
	static void NETWORK_SET_MISSION_FINISHED() { invoke<Void>(0x3B3D11CD9FFCDFC9); } // 0x3B3D11CD9FFCDFC9 0x3083FAD7
	static BOOL NETWORK_IS_SCRIPT_ACTIVE(char* scriptName, int instanceId, BOOL unk, int positionHash) { return invoke<BOOL>(0x9D40DF90FAD26098, scriptName, instanceId, unk, positionHash); } // 0x9D40DF90FAD26098 0x4A65250C
	...
	static BOOL NETWORK_IS_PLAYER_A_PARTICIPANT_ON_SCRIPT(Player p0, Any* p1, Any p2) { return invoke<BOOL>(0x1AD5B71586B94820, p0, p1, p2); } // 0x1AD5B71586B94820 0xCEA55F4C
	...
	static BOOL _NETWORK_GET_DESTROYER_OF_ENTITY(Any p0, Any p1, Hash* weaponHash) { return invoke<BOOL>(0x4CACA84440FA26F6, p0, p1, weaponHash); } // 0x4CACA84440FA26F6 0x28A45454
	...
	static BOOL _NETWORK_IS_DOOR_NETWORKED(Hash doorHash) { return invoke<BOOL>(0xC01E93FAC20C3346, doorHash); } // 0xC01E93FAC20C3346
	...
	static BOOL _NETWORK_IS_FRIEND_HANDLE_ONLINE(int* networkHandle) { return invoke<BOOL>(0x87EB7A3FFCB314DB, networkHandle); } // 0x87EB7A3FFCB314DB
	...
	static void _NETWORK_SET_PASSIVE_MODE(BOOL p0) { invoke<Void>(0x1B857666604B1A74, p0); } // 0x1B857666604B1A74
	...
	static void _GET_PLAYER_WAYPOINT_COORDS(Player p0, float* p1, float* p2) { invoke<Void>(0xADB57E5B663CCA8B, p0, p1, p2); } // 0xADB57E5B663CCA8B 0x92268BB5
	...
	static void REMOVE_ALL_STICKY_BOMBS_FROM_ENTITY(Entity entity) { invoke<Void>(0x715135F4B82AC90D, entity); } // 0x715135F4B82AC90D 0xCEAE5AFC
	...
	static void _NETWORK_SET_NETWORK_ID_CAN_BE_SEEN(int netId, BOOL state) { invoke<Void>(0x3FA36981311FA4FF, netId, state); } // 0x3FA36981311FA4FF 0x00AE4E17
	...
	static BOOL _0x631DC5DFF4B110E3(Player index) { return invoke<BOOL>(0x631DC5DFF4B110E3, index); } // 0x631DC5DFF4B110E3
	static BOOL _0x422F32CC7E56ABAD(Vehicle vehicle) { return invoke<BOOL>(0x422F32CC7E56ABAD, vehicle); } // 0x422F32CC7E56ABAD
	...
	static BOOL IS_SPHERE_VISIBLE_TO_PLAYER(Player player, float x, float y, float z, float scale) { return invoke<BOOL>(0xDC3A310219E5DA62, player, x, y, z, scale); } // 0xDC3A310219E5DA62 0xE9FCFB32
	...
	static int GET_NUM_CREATED_MISSION_OBJECTS(BOOL p0) { return invoke<int>(0x12B6281B6C6706C0, p0); } // 0x12B6281B6C6706C0 0x603FA104
	static int GET_NUM_CREATED_MISSION_PEDS(BOOL p0) { return invoke<int>(0xCB215C4B56A7FAE7, p0); } // 0xCB215C4B56A7FAE7 0xD8FEC4F8
	static int GET_NUM_CREATED_MISSION_VEHICLES(BOOL p0) { return invoke<int>(0x0CD9AB83489430EA, p0); } // 0x0CD9AB83489430EA 0x20527695
	static Any GET_MAX_NUM_NETWORK_OBJECTS() { return invoke<Any>(0xC7BE335216B5EC7C); } // 0xC7BE335216B5EC7C 0x8687E285
	...
	static int _GET_NETWORK_TIME2() { return invoke<int>(0x89023FBBF9200E9F); } // 0x89023FBBF9200E9F 0x98AA48E5
	...
	static BOOL NETWORK_START_RESPAWN_SEARCH_FOR_PLAYER(Player player, float p1, float p2, float p3, float p4, float p5, float p6, float p7, int flags) { return invoke<BOOL>(0x5A6FFA2433E2F14C, player, p1, p2, p3, p4, p5, p6, p7, flags); } // 0x5A6FFA2433E2F14C 0xC62E77B3
	static BOOL NETWORK_START_RESPAWN_SEARCH_IN_ANGLED_AREA_FOR_PLAYER(Player player, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, float p9, float p10, int flags) { return invoke<BOOL>(0x4BA92A18502BCA61, player, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, flags); } // 0x4BA92A18502BCA61 0x74D6B13C
	static Any _0x3C891A251567DFCE(Any* p0) { return invoke<Any>(0x3C891A251567DFCE, p0); } // 0x3C891A251567DFCE 0x90700C7D
	static void NETWORK_CANCEL_RESPAWN_SEARCH() { invoke<Void>(0xFB8F2A6F3DF08CBE); } // 0xFB8F2A6F3DF08CBE 0x44BFB619
	...
	static void _NETWORK_SET_NETWORK_ID_HAS_PHYSICALITY(int netID, BOOL toggle) { invoke<Void>(0x2B1813ABA29016C5, netID, toggle); } // 0x2B1813ABA29016C5 0x155465EE
	...
	static BOOL _0x6D4CB481FAC835E8(Any p0, Any p1, char* p2, Any p3) { return invoke<BOOL>(0x6D4CB481FAC835E8, p0, p1, p2, p3); } // 0x6D4CB481FAC835E8 0x40CF0783
	...
	static BOOL _GET_CLAN_CONTENT(Any p0, Any p1, Any p2, Any* p3, Any* p4) { return invoke<BOOL>(0x9F6E2821885CAEE2, p0, p1, p2, p3, p4); } // 0x9F6E2821885CAEE2 0xA6D8B798
...
{
	static void NETWORK_INITIALIZE_CASH(Player p1, int p2) { invoke<Void>(0x3DA5ECD1A56CBA6D, p1, p2); } // 0x3DA5ECD1A56CBA6D 0x66DA9935
	...
	static void NETWORK_REFUND_CASH(int m_Index, char* szType, char* szReason, BOOL bUnk) { invoke<Void>(0xF9C812CD7C46E817, m_Index, szType, szReason, bUnk); } // 0xF9C812CD7C46E817 0x07C92F21
	...
	static void _NETWORK_EARN_FROM_JOB_BONUS(Any amont, Any* p1, Any* p2) { invoke<Void>(0x6816FB4416760775, amont, p1, p2); } // 0x6816FB4416760775
	...
	static void NETWORK_SPENT_BULL_SHARK(int amount, BOOL p1, BOOL p2) { invoke<Void>(0xA6DD8458CE24012C, amount, p1, p2); } // 0xA6DD8458CE24012C 0xDE7D398C
	...
	static BOOL _IS_CASH_GIFT_AVAILABLE() { return invoke<BOOL>(0x7C4FCCD2E4DEB394); } // 0x7C4FCCD2E4DEB394
...
namespace DLC1
{
	...
	static int _GET_VARIANTS_FOR_COMPONENT_COUNT(Hash componentHash) { return invoke<int>(0xC17AD0E5752BECDA, componentHash); } // 0xC17AD0E5752BECDA 0x159751B4
	...
	static Any _GET_FORCED_COMPONENT(Any p0) { return invoke<Any>(0x017568A8182D98A6, p0); } // 0x017568A8182D98A6
	...
	static BOOL _IS_TAG_RESTRICTED(Hash componentHash, Hash restrictionTag, int componentId) { return invoke<BOOL>(0x341DE7ED1D2A1BFD, componentHash, restrictionTag, componentId); } // 0x341DE7ED1D2A1BFD 0x8E2C7FD5
	static int _GET_CHARACTER_OUTFITS_COUNT(int character, BOOL p1) { return invoke<int>(0xF3FBE2D50A6A8C28, character, p1); } // 0xF3FBE2D50A6A8C28 0x1ECD23E7
	...
	static BOOL GET_SHOP_PED_OUTFIT_PROP_VARIANT(Any outfitStruct, int slot, Any* propStruct) { return invoke<BOOL>(0xA9F9C2E0FDE11CBB, outfitStruct, slot, propStruct); } // 0xA9F9C2E0FDE11CBB 0x6641A864
	static BOOL GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Any outfitStruct, int slot, Any* componentStruct) { return invoke<BOOL>(0x19F2A026EDF0013F, outfitStruct, slot, componentStruct); } // 0x19F2A026EDF0013F 0x818534AC
...
namespace SOCIALCLUB
{
	...
	static void _CREATE_PRESENCE_STAT_UPDATE(char* p0) { invoke<Void>(0xA68D3D229F4F3B06, p0); } // 0xA68D3D229F4F3B06 0x75324674
	...
	static BOOL _CREATE_PRESENCE_BOUNTY(char* playerName) { return invoke<BOOL>(0x6AFD2CD753FEEF83, playerName); } // 0x6AFD2CD753FEEF83 0x628F489B
...
namespace UNK
{
	...
	static BOOL _RETURN_ZERO2() { return invoke<BOOL>(0xEF7D17BC6C85264C); } // 0xEF7D17BC6C85264C 0xD87F3A9E
...
namespace UNK1
{
	static void _0x48621C9FCA3EBD28(int p0) { invoke<Void>(0x48621C9FCA3EBD28, p0); } // 0x48621C9FCA3EBD28
	...
	static void _0x293220DA1B46CEBC(float p0, float p1, int p2) { invoke<Void>(0x293220DA1B46CEBC, p0, p1, p2); } // 0x293220DA1B46CEBC
...
namespace UNK2
{
	static void _TOGGLE_PHONE_FILTER(char* p0, BOOL p1) { invoke<Void>(0x7E2BD3EF6C205F09, p0, p1); } // 0x7E2BD3EF6C205F09
	static BOOL _IS_INTERIOR_RENDERING_DISABLED() { return invoke<BOOL>(0x95AB8B5C992C7B58); } // 0x95AB8B5C992C7B58
	static void _DISABLE_UNKNOWN_RENDERING() { invoke<Void>(0x5AD3932DAEB1E5D3); } // 0x5AD3932DAEB1E5D3
...
namespace UNK3
{
	...
	static BOOL* _NET_GAMESERVER_CATALOG_IS_READY() { return invoke<BOOL*>(0x3C4487461E9B0DCB); } // 0x3C4487461E9B0DCB
	...
	static BOOL _NETWORK_SHOP_BEGIN_SERVICE(int* transactionID, Hash p1, Hash transactionHash, Hash transactionType, int ammount, int mode) { return invoke<BOOL>(0x3C5FD37B5499582E, transactionID, p1, transactionHash, transactionType, ammount, mode); } // 0x3C5FD37B5499582E
